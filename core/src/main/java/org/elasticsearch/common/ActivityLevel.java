...
/**
 * Activity level that allows to define when out of total elements and active elements
 * the is met.
 */
public enum ActivityLevel {
    ...
    public static ActivityLevel readFrom(StreamInput in) throws IOException {
        return ActivityLevel.values()[(int) in.readByte()];
    }
    ...
    public static ActivityLevel fromString(String value, ActivityLevel defaultValue) {
        if (value == null) {
            return defaultValue;
        }
